...
Note also that we have modelled this random experiment using a continuous random variable and its pdf (and cdf). Compare this with the more "direct" model of ![[1.4 Probability#Example 1.9 (Drawing a Point in an Interval | Example 1.9]]

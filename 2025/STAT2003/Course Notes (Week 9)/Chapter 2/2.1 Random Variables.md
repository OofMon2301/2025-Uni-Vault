...
We usually denote random variables with *capital* letters from the last part of the alphabet, eg. $X,X_{1},X_{2},\dots ,Y,Z$, Random variables allow us to use natural and intuitive notations for certain events, such as $\{ X=10 \},\{ \max \}$